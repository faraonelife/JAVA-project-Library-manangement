...
public class ReturnforSTD extends JFrame{
    static ReturnforSTD staticobject;
    ...
    public ReturnforSTD() {
        ...
        btnReturnBook.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(i>0){
                    JOptionPane.showMessageDialog(ReturnforSTD.this,"Book returned");
                    StudentPanel.main(new String[]{});
                    staticobject.dispose();

                }else{
                    JOptionPane.showMessageDialog(ReturnforSTD.this,"Impossible to return");
                }
            }
        });
        ...
        gridLay.setHorizontalGroup(
                gridLay.createParallelGroup(GroupLayout.Alignment.TRAILING)
                        .addGroup(gridLay.createSequentialGroup()
                                .addGap(36)
                                .addGroup(gridLay.createParallelGroup(GroupLayout.Alignment.TRAILING, true)
                                        .addComponent(lblStdId, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(lblbookNO, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE))
                                .addGap(56)
